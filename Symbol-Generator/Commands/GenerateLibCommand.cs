...
using Amethyst.SymbolGenerator.Tools.MSVC;
...
{
    [Command("gen-lib", Description = "Generates a library file based on the provided symbol files.")]
    public class GenerateLibCommand : ICommand
    {
